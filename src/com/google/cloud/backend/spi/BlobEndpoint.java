...
public class BlobEndpoint {
  /**
   * Pseudo user id used when Starwheel Backend Starter is configured in Open mode and the requests are
  ...
  private String getUserId(User user) {
    if (user == null) {
      // Starwheel Backend is configured in Open Mode and the requests are unauthenticated.
